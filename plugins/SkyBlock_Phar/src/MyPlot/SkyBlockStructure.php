...
class SkyBlockStructure extends Populator{
	...
	public static function placeObject(ChunkManager $level, $chunk, $Xofchunk, $Zofchunk){
		...
		$level->setBlockIdAt($vec->x + 6, 69, $vec->z + 7, Block::LOG);
			$level->setBlockIdAt($vec->x + 8, 68, $vec->z + 7, Block::LOG);
			$level->setBlockIdAt($vec->x + 7, 69, $vec->z + 6, Block::CRAFTING_TABLE);
			$level->setBlockIdAt($vec->x + 6, 69, $vec->z + 7, Block::LOG);
				$level->setBlockIdAt($vec->x + 5, 69, $vec->z + 9, Block::CACTUS);
					$level->setBlockIdAt($vec->x + 5, 68, $vec->z + 9, Block::SAND);
				$level->setBlockIdAt($vec->x + 9, 69, $vec->z + 8, Block::DOUBLE_PLANT);
				//Grass
					$level->setBlockIdAt($vec->x + 10, 69, $vec->z + 7, Block::GRASS);
				$level->setBlockIdAt($vec->x + 10, 69, $vec->z + 6, Block::GRASS);
				
				$level->setBlockIdAt($vec->x + 10, 69, $vec->z + 5, Block::GRASS);
				$level->setBlockIdAt($vec->x + 9, 69, $vec->z + 4, Block::GRASS);
				$level->setBlockIdAt($vec->x + 8, 69, $vec->z + 4, Block::GRASS);
				$level->setBlockIdAt($vec->x + 9, 69, $vec->z + 5, Block::GRASS);
				$level->setBlockIdAt($vec->x + 9, 69, $vec->z + 6, Block::GRASS);
				//red_flower RED_FLOWER
				$level->setBlockIdAt($vec->x + 6, 69, $vec->z + 5, Block::RED_FLOWER);
				//red_mushroom RED_MUSHROOM
				$level->setBlockIdAt($vec->x + 6, 69, $vec->z + 4, Block::RED_MUSHROOM);
				//furnace FURNACE
				$level->setBlockIdAt($vec->x + 7, 70, $vec->z + 6, Block::FURNACE);
				$level->setBlockIdAt($vec->x + 5, 69, $vec->z + 8, Block::LIT_PUMPKIN);
				$level->setBlockIdAt($vec->x + 10, 70, $vec->z + 5, Block::TALL_GRASS);
				$level->setBlockIdAt($vec->x + 6, 69, $vec->z + 9, Block::TALL_GRASS);
				$level->setBlockIdAt($vec->x + 7, 74, $vec->z + 8, Block::LOG);
				// SUGARCANE_BLOCK
				$level->setBlockIdAt($vec->x + 5, 69, $vec->z + 5, Block::SUGARCANE_BLOCK);
				$level->setBlockIdAt($vec->x + 5, 70, $vec->z + 5, Block::SUGARCANE_BLOCK);
				$level->setBlockIdAt($vec->x + 5, 71, $vec->z + 5, Block::SUGARCANE_BLOCK);
				//DONE !
