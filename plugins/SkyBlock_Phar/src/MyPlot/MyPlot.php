<?php
    ...
    class LevelLoaderTask extends PluginTask {
        
        public function onRun($t) {
            $pg = \pocketmine\Server::getInstance();
            
            $pg->getPluginManager()->getPlugin("ManyWorlds")->autoLoad(new \pocketmine\command\ConsoleCommandSender(), "sb");
            $pg->getPluginManager()->getPlugin("ManyWorlds")->autoLoad(new \pocketmine\command\ConsoleCommandSender(), "shop");
        }
    }
    ...
    public function teleportMiddle(Player $player, Plot $plot): bool{
        ...
        public function onEnable() {
            ...
            $this->getLogger()->info("Đang Chạy Plugin SkyBlock Bởi XxBoomer");
            self::$instance = $this;
